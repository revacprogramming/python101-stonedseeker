...
5454 Writing programs (or programming) is a very creative 
...
8604 This very fact that computers are good at things 7194
...
creative 37 activity. 2199  3057 Your computer or Personal Digital Assistant (PDA) 
...
4396 perhaps the following figure is a more sensible version of our PDA:
...
speak 3388 to 8208 give 3191 instructions to computers to 
...
learn 2133 how 3864 to 6491 talk fast to keep up with the CPU.
 
Main Memory is used to store information
that the CPU needs in a hurry.  The main memory is nearly as 
1501 fast as the CPU.  But the information stored in the main 9132
...
6060 store information even when there is no power to the 435
...
8923 We can think of the network as a very slow place to store and
...
and 4570 analyze 3913 the 4966 data you get from the solution.  As a programmer you will 
 mostly be talking to the CPU and telling it what to 
do next.  Sometimes you will tell the CPU to use the main memory,
141 secondary memory, network, or the input/output devices.
...
2834 programmer --- perhaps not a professional programmer, but 9841
at least you will have the skills to look at a data/information
270 analysis problem and develop a program to solve the problem.

3898 problem solving 5325
...
9285 well-formed sentences in this new language.
...
7261 feedback.  In programming, our program is the story and the 793
4924 problem you are trying to solve is the idea. 8803
...
1332 as the simple examples remind you of when you started reading for the first 8577
time. 
...
don't 4697 use 4180 any 7804 of the reserved words, they just look at you with a 
...
9146 what most dogs likely hear is,
blah blah blah walk blah blah blah blah.
That is because walk is a reserved word in dog language.  

The 5875 reserved 7702 words 3732 in the language where humans talk to 
...
1189 And we have even written our first syntactically correct Python sentence.
Our sentence starts with the reserved word print followed
5591 by a string of text of our choosing enclosed in single quotes. 710
...
340 computer.  That is too much detail for this chapter so I suggest 8478
5920 that you consult www.py4e.com where I have detailed
...
7299 The >>> prompt is the Python interpreter's way of asking you, What
...
6840 the inhabitants of the planet are likely to stab you with their spears, 
...
so 4053 we 7187 can 823 retrieve the value later.   We verify that Python has actually remembered
...
8654 as shown above.  A compiler needs to be handed the entire program in a file, and then 8188
...
8430 To execute the script, you have to tell the Python interpreter 
...
What 7192 is 8011 a 4930 program?
...
data = re.findall('[0-9]+',dataFormat)
